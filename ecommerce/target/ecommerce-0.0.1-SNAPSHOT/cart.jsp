...
<body>
	...
	<div class="container">
		<div class="tab-content">
			...
			<div id="viewcart" class="tab-pane fade in active">
			<div align="center">Cart List</div>			
			<a href="index.jsp">Show Product List</a><br>
