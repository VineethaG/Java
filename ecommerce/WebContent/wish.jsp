...
<body>
	...
	<div class="container">
		<div class="tab-content">
			...
			<div id="viewwish" class="tab-pane fade in active">
												<div align="center">Wish List</div>
			<a href="index.jsp" align="right">Show Product List</a></br>
			<a href="cart.jsp">Show Cart List</a>
